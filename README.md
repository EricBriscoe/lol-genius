...
Download the latest installer from [Releases](https://github.com/EricBriscoe/lol-genius/releases). The desktop app runs on your gaming PC and connects directly to the League Live Client API (`localhost:2999`) for real-time win probability predictions; no port forwarding is needed.
